...
var scenes;
(function (scenes) {
    var Twelve = (function (_super) {
        __extends(Twelve, _super);
        // CONSTRUCTOR ++++++++++++++++++++++
        function Twelve() {
            _super.call(this);
        }
        // PUBLIC METHODS +++++++++++++++++++++
        // Start Method
        Twelve.prototype.start = function () {
            // add the PLAY label to the scene
            this._playLabel = new createjs.Text("", "20px Consolas", "#000000");
            this._playLabel.text += "You chose the dark purple road. A bear jumps out from \n\n";
            this._playLabel.text += "behind a tree and eats you up! \n\n";
        ...
        Twelve.prototype.update = function () {
        };
        //EVENT HANDLERS ++++++++++++++++++++
        // NEXT Button click event handler
        Twelve.prototype._leftButtonClick = function (event) {
